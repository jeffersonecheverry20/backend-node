...
mongoose.connect('mongodb+srv://jsecheverry:mongodbprueba@cluster0-tdblj.mongodb.net/test?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false}, function(err, res){
    if(err){
